...
function ReceiptPDF() {
  ...
  const fetch = () => {
    axios
      .post("/api/v1/Receipt/GetReceiptData", {
        LedgerTransactionID: location?.state?.data,
      })
      .then((res) => {
  ...
  useEffect(() => {
    ...
    let TotalDueAmount = TotalAmount - TotalDiscount - TotalPaidAmount;
  ...
  return (
    <PDFViewer style={styles.viewer}>
      ...
      <Document>
        ...
        <Page
          size={pageSetting?.pageSetup?.PageSize}
          style={styles.page}
          orientation={
          ...
          <View>
            {pageSetting?.pageData[0]?.TemplateID == 1 ? (
              ...
              <View>
                ...
                >
                  <View
                    style={[styles.table, { marginTop: "20px", width: "80%" }]}
                  >
                    <View
                      style={[
                        styles.tableRow,
                    ...
                    {pageSetting?.SettlementData?.map((data, ind) => (
                      <View style={styles.tableRow} index={ind}>
                        ...
                        <View style={[styles.tableCol]}>
                          <Text style={styles.tableCell}>
                            {data?.S_Currency ? data?.S_Currency : "INR"}
                          </Text>
                        </View>
                        <View style={[styles.tableCol]}>
                          <Text style={styles.tableCell}>{data?.S_Amount}</Text>
                        </View>
                        <View style={[styles.tableCol]}>
                          <Text style={styles.tableCell}>{data?.C_Factor}</Text>
                        </View>
                        <View style={[styles.tableCol]}>
                          <Text
                            style={[styles.tableCell, { textAlign: "right" }]}
                ...
                <View>
                  <View>
                    <Text style={{ fontSize: "8px", marginTop: "10px" }}>
                      * This is a Computer generated document, does not require
                      any signature.
                    </Text>
                  </View>
                </View>
